...
public class ass02 {
    ...
    public static void main(String[] args) {
        ass02 t = new ass02();
        int[] t1 = {2, 7, 11, 15};
        //System.out.println(Arrays.toString(t.twoSumIndice(t1, 9)));
        int[][] t2 = {{0, 30}, {5, 10}, {15, 20}};
        //System.out.println(t.minMeetingRoom(t2));

        int[] nums1 = {4, 9, 5}, nums2 = {9, 4, 9, 8, 4};
        //System.out.println(t.getIntersection(nums1, nums2));

        int[] t4 = {2, 2};
        System.out.println(t.getAllMoreThanN3(t4));

        int[] t5 = {5, 7, 7, 8, 8, 10};
        //System.out.println(Arrays.toString(t.findStEd(t5, 6)));
        ...
        int[][] t6 = {{4, 3, 2, -1},
                ...
                {1, -1, -2, -3}};
        int[][] t61 = {{-1, -1}, {-1, -1}};
        //System.out.println(t.countNegNum(t61));

        int[] t7 = {1, 2};
        //System.out.println(t.findPeak(t7));

        int[] t8 = {1, 1};
        //System.out.println(t.findDupNumber(t8));

        int[] t9 = {2, 3, 4, 7, 11};
        int[] t91 = {1, 11, 12, 13, 14};
        //System.out.println(t.findMissingNum(t9, 5));
